...
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 0), 'Music Festival', 'An outdoor music festival with various artists.', 'https://goo.gl/maps/abc123', 'Entertainment', '2024-12-01T18:00:00+00:00', 'https://placehold.co/1366x768?text=event0'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 1), 'Art Exhibition', 'An exhibition showcasing modern art.', 'https://goo.gl/maps/def456', 'Art', '2025-01-15T10:00:00+00:00', 'https://placehold.co/1366x768?text=event1'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 2), 'Tech Conference', 'Annual conference for tech enthusiasts.', 'https://goo.gl/maps/ghi789', 'Conference', '2025-02-20T09:00:00+00:00', 'https://placehold.co/1366x768?text=event2'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 3), 'Cooking Workshop', 'Hands-on cooking workshop with a celebrity chef.', 'https://goo.gl/maps/jkl012', 'Workshop', '2025-03-05T14:00:00+00:00', 'https://placehold.co/1366x768?text=event3'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 4), 'Charity Run', 'A 5K run to raise funds for charity.', 'https://goo.gl/maps/mno345', 'Sports', '2025-04-10T07:00:00+00:00', 'https://placehold.co/1366x768?text=event4'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 5), 'Book Launch', 'Launch event for a new book by a bestselling author.', 'https://goo.gl/maps/pqr678', 'Literature', '2025-05-01T18:30:00+00:00', 'https://placehold.co/1366x768?text=event5'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 6), 'Yoga Retreat', 'A weekend retreat focusing on yoga and wellness.', 'https://goo.gl/maps/stu901', 'Health', '2025-06-15T08:00:00+00:00', 'https://placehold.co/1366x768?text=event6'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 7), 'Film Screening', 'Special screening of an indie film.', 'https://goo.gl/maps/vwx234', 'Entertainment', '2025-07-20T20:00:00+00:00', 'https://placehold.co/1366x768?text=event7'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 8), 'Science Fair', 'Annual science fair showcasing student projects.', 'https://goo.gl/maps/yza567', 'Education', '2025-08-10T09:00:00+00:00', 'https://placehold.co/1366x768?text=event8'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 9), 'Gardening Workshop', 'Learn about urban gardening techniques.', 'https://goo.gl/maps/bcd890', 'Workshop', '2025-09-05T13:00:00+00:00', 'https://placehold.co/1366x768?text=event9'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 10), 'Dance Performance', 'A contemporary dance performance.', 'https://goo.gl/maps/efg123', 'Entertainment', '2025-10-01T19:00:00+00:00', 'https://placehold.co/1366x768?text=event10'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 11), 'Business Meetup', 'Networking event for business professionals.', 'https://goo.gl/maps/hij456', 'Networking', '2025-11-15T17:00:00+00:00', 'https://placehold.co/1366x768?text=event11'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 12), 'Photography Exhibition', 'Exhibition featuring travel photography.', 'https://goo.gl/maps/klm789', 'Art', '2025-12-20T11:00:00+00:00', 'https://placehold.co/1366x768?text=event12'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 13), 'Fitness Bootcamp', 'Intense fitness bootcamp session.', 'https://goo.gl/maps/nop012', 'Health', '2026-01-05T06:00:00+00:00', 'https://placehold.co/1366x768?text=event13'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 14), 'Cooking Class', 'Learn to cook traditional dishes.', 'https://goo.gl/maps/qrs345', 'Workshop', '2026-02-12T14:00:00+00:00', 'https://placehold.co/1366x768?text=event14'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 15), 'Career Fair', 'Career fair for recent graduates.', 'https://goo.gl/maps/tuv678', 'Education', '2026-03-10T10:00:00+00:00', 'https://placehold.co/1366x768?text=event15'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 16), 'Music Concert', 'Live concert by a popular band.', 'https://goo.gl/maps/wxy901', 'Entertainment', '2026-04-25T20:00:00+00:00', 'https://placehold.co/1366x768?text=event16'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 17), 'Theater Play', 'Local theater group performing a classic play.', 'https://goo.gl/maps/zab234', 'Entertainment', '2026-05-18T19:30:00+00:00', 'https://placehold.co/1366x768?text=event17'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 18), 'Workshop on Coding', 'Introductory workshop on programming.', 'https://goo.gl/maps/cde567', 'Education', '2026-06-07T09:00:00+00:00', 'https://placehold.co/1366x768?text=event18'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 19), 'Environmental Seminar', 'Seminar on climate change and sustainability.', 'https://goo.gl/maps/fgh890', 'Education', '2026-07-22T14:00:00+00:00', 'https://placehold.co/1366x768?text=event19'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 20), 'Food Festival', 'A festival celebrating local cuisine.', 'https://goo.gl/maps/ijk123', 'Entertainment', '2026-08-30T12:00:00+00:00', 'https://placehold.co/1366x768?text=event20'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 21), 'Mindfulness Retreat', 'A weekend retreat focusing on mindfulness and meditation.', 'https://goo.gl/maps/lmn456', 'Health', '2026-09-18T08:00:00+00:00', 'https://placehold.co/1366x768?text=event21'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 22), 'Charity Gala', 'A gala event to raise funds for charity.', 'https://goo.gl/maps/opq789', 'Networking', '2026-10-10T18:00:00+00:00', 'https://placehold.co/1366x768?text=event22'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 23), 'Cultural Festival', 'A festival celebrating diverse cultures.', 'https://goo.gl/maps/rst012', 'Entertainment', '2026-11-05T10:00:00+00:00', 'https://placehold.co/1366x768?text=event23'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 24), 'Public Speaking Workshop', 'Improve your public speaking skills.', 'https://goo.gl/maps/uvw345', 'Workshop', '2026-12-01T09:00:00+00:00', 'https://placehold.co/1366x768?text=event24'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 25), 'Product Launch', 'Launch event for a new tech product.', 'https://goo.gl/maps/xyz678', 'Conference', '2026-12-15T15:00:00+00:00', 'https://placehold.co/1366x768?text=event25'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 26), 'Art Fair', 'A fair showcasing local artists and their work.', 'https://goo.gl/maps/abc901', 'Art', '2027-01-20T10:00:00+00:00', 'https://placehold.co/1366x768?text=event26'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 27), 'Writing Workshop', 'Workshop on creative writing techniques.', 'https://goo.gl/maps/def234', 'Workshop', '2027-02-05T14:00:00+00:00', 'https://placehold.co/1366x768?text=event27'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 28), 'Health Fair', 'A fair promoting health and wellness.', 'https://goo.gl/maps/ghi567', 'Health', '2027-03-10T08:00:00+00:00', 'https://placehold.co/1366x768?text=event28'),
(uuid_generate_v4(), (SELECT id FROM account LIMIT 1 OFFSET 29), 'Innovation Summit', 'Summit on innovation and entrepreneurship.', 'https://goo.gl/maps/jkl890', 'Conference', '2027-04-25T09:00:00+00:00', 'https://placehold.co/1366x768?text=event29');
